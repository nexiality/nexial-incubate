...
public final class NexialConst {
    ...
    public static final String OPT_DEF_DATABASE_DIR = NAMESPACE + "defaultDBPath";
    public static final String OPT_DEF_DATABASE_NAME = NAMESPACE + "defaultDBName";
    public static final String DEF_DATABASE_NAME = "Nexial";
    ...
    public static final class Project {
        ...
        public static final String NEXIAL_EXECUTION_ID = NAMESPACE + "executionId";
